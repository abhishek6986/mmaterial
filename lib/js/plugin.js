...
(function($, window, undefined) {
	...
	Backstretch.prototype = {
		...
		restart: function() {
			var oldImage = this.$wrap.find('img').addClass('deleteable');
			oldImage.remove();
			this.paused = false;
			this.index = 0;
			this.show(this.index);
	...
	a.fn.visible = function(a, c, d, e) {
		if(!(this.length < 1)) {
			var f = this.length > 1 ? this.eq(0) : this,
				...
				i = b.height(),
				d = d ? d : "both",
				j = c === !0 ? g.offsetWidth * g.offsetHeight : !0,
				e = e ? e : 0;
			if("function" == typeof g.getBoundingClientRect) {
				var k = g.getBoundingClientRect(),
					l = k.top >= 0 && k.top < i + e,
					m = k.bottom > 0 && k.bottom <= i,
					n = k.left >= 0 && k.left < h,
					o = k.right > 0 && k.right <= h,
					p = a ? l || m : l && m,
					q = a ? n || o : n && o;
				if("both" === d) return j && p && q;
				if("vertical" === d) return j && p;
				if("horizontal" === d) return j && q
			} else {
				var r = b.scrollTop(),
					s = r + i + e,
					t = b.scrollLeft(),
					...
					C = a === !0 ? z : y,
					D = a === !0 ? y : z;
				if("both" === d) return !!j && s >= B && A >= r && u >= D && C >= t;
				if("vertical" === d) return !!j && s >= B && A >= r;
				if("horizontal" === d) return !!j && u >= D && C >= t
			}
		}
	}
}(jQuery);;
...
! function(e, t, s) {
	...
	var a = [],
		l = function(s, i) {
			var n;
			return e.isMobile && !i.mobile ? !1 : this === e ? new l(s, i) : ("string" == typeof s && "#" === s[0] && (s = t.getElementById(s.substr(1))), (n = s.getAttribute("data-dkcacheid")) ? (d.extend(a[n].data.settings, i), a[n]) : "SELECT" === s.nodeName ? this.init(s, i) : void 0)
		},
		n = function() {},
		o = {
			initialize: n,
		...
		d = {
			...
			addClass: function(e, t) {
				e && !d.hasClass(e, t) && (e.className += " " + t)
			},
			removeClass: function(e, t) {
				var s = new RegExp("(^|\\s+)" + t + "(\\s+|$)");
			...
			toggleClass: function(e, t) {
				var s = d.hasClass(e, t) ? "remove" : "add";
				d[s + "Class"](e, t)
			},
			extend: function(e) {
			...
			offset: function(s) {
				var i = s.getBoundingClientRect() || {
					...
					a = t.documentElement;
				return {
					top: i.top + e.pageYOffset - a.clientTop,
					left: i.left + e.pageXOffset - a.clientLeft
				}
			},
			position: function(e, t) {
				for(var s = {
						top: 0,
						left: 0
					}; e !== t;) s.top += e.offsetTop, s.left += e.offsetLeft, e = e.parentNode;
				return s
			},
			...
			create: function(e, s) {
				...
				s || (s = {});
				for(i in s) s.hasOwnProperty(i) && ("innerHTML" == i ? a.innerHTML = s[i] : a.setAttribute(i, s[i]));
				return a
			}
		};
	l.prototype = {
		add: function(e, s) {
			var i, a, l;
			"string" == typeof e && (i = e, e = t.createElement("option"), e.text = i), "OPTION" === e.nodeName && (a = d.create("li", {
				"class": "dk-option",
				"data-value": e.value,
				innerHTML: e.text,
				role: "option",
			...
			}), d.addClass(a, e.className), this.length += 1, e.disabled && (d.addClass(a, "dk-option-disabled"), a.setAttribute("aria-disabled", "true")), this.data.select.add(e, s), "number" == typeof s && (s = this.item(s)), this.options.indexOf(s) > -1 ? s.parentNode.insertBefore(a, s) : this.data.elem.lastChild.appendChild(a), a.addEventListener("mouseover", this), l = this.options.indexOf(s), this.options.splice(l, 0, a), e.selected && this.select(l))
		},
		item: function(e) {
		...
		init: function(s, i) {
			var n, r = l.build(s, "dk" + a.length);
			if(this.data = {}, this.data.select = s, this.data.elem = r.elem, this.data.settings = d.extend({}, o, i), this.disabled = s.disabled, this.form = s.form, this.length = s.length, this.multiple = s.multiple, this.options = r.options.slice(0), this.selectedIndex = s.selectedIndex, this.selectedOptions = r.selected.slice(0), this.value = s.value, s.parentNode.insertBefore(this.data.elem, s), this.data.elem.addEventListener("click", this), this.data.elem.addEventListener("keydown", this), this.data.elem.addEventListener("keypress", this), this.form && this.form.addEventListener("reset", this), !this.multiple)
				for(n = 0; n < this.options.length; n++) this.options[n].addEventListener("mouseover", this);
			return 0 === a.length && (t.addEventListener("click", l.onDocClick), e.isIframe && parent.document.addEventListener("click", l.onDocClick)), this.data.cacheID = a.length, s.setAttribute("data-dkCacheId", this.data.cacheID), a.push(this), this.data.settings.initialize.call(this), this
		},
		close: function() {
			var e = this.data.elem;
			if(!this.isOpen || this.multiple) return !1;
			for(i = 0; i < this.options.length; i++) d.removeClass(this.options[i], "dk-option-highlight");
		...
		open: function() {
			var t, s, i, a = this.data.elem,
				l = a.lastChild,
				n = d.offset(a).top - e.scrollY,
				o = e.innerHeight - (n + a.offsetHeight);
			return this.isOpen || this.multiple ? !1 : (l.style.display = "block", t = l.offsetHeight, l.style.display = "", s = n > t, i = o > t, direction = s && !i ? "-up" : "-down", this.isOpen = !0, d.addClass(a, "dk-select-open" + direction), l.setAttribute("aria-expanded", "true"), this._scrollTo(this.options.length - 1), this._scrollTo(this.selectedIndex), void this.data.settings.open.call(this))
		},
		disable: function(e, t) {
			var i = "dk-option-disabled";
			(0 == arguments.length || "boolean" == typeof e) && (t = e === s ? !0 : !1, e = this.data.elem, i = "dk-select-disabled", this.disabled = t), t == s && (t = !0), "number" == typeof e && (e = this.item(e)), d[t ? "addClass" : "removeClass"](e, i)
		},
		select: function(e, t) {
			var s, i, a, l = this.data.select;
			return "number" == typeof e && (e = this.item(e)), !t && d.hasClass(e, "dk-option-disabled") ? !1 : d.hasClass(e, "dk-option") ? (s = this.options.indexOf(e), i = l.options[s], this.multiple ? (d.toggleClass(e, "dk-option-selected"), i.selected = !i.selected, d.hasClass(e, "dk-option-selected") ? (e.setAttribute("aria-selected", "true"), this.selectedOptions.push(e)) : (e.setAttribute("aria-selected", "false"), s = this.selectedOptions.indexOf(e), this.selectedOptions.splice(s, 1))) : (a = this.data.elem.firstChild, this.selectedOptions.length && (d.removeClass(this.selectedOptions[0], "dk-option-selected"), this.selectedOptions[0].setAttribute("aria-selected", "false")), d.addClass(e, "dk-option-selected"), e.setAttribute("aria-selected", "true"), a.setAttribute("aria-activedescendant", e.id), a.innerHTML = i.text, this.selectedOptions[0] = e, i.selected = !0), this.selectedIndex = l.selectedIndex, this.value = l.value, this.data.settings.change.call(this), e) : void 0
		},
		selectOne: function(e, t) {
			return this.reset(!0), this._scrollTo(e), this.select(e, t)
		},
		search: function(e, t) {
			var s, i, a, l, n, o, d, r, h = this.data.select.options,
				c = [];
			...
			for(t = t ? t.toLowerCase() : "strict", t = "fuzzy" == t ? 2 : "partial" == t ? 1 : 0, r = new RegExp((t ? "" : "^") + e, "i"), s = 0; s < h.length; s++)
				if(a = h[s].text.toLowerCase(), 2 == t) {
					for(i = e.toLowerCase().split(""), l = n = o = d = 0; n < a.length;) a[n] === i[l] ? (o += 1 + o, l++) : o = 0, d += o, n++;
					l == i.length && c.push({
						e: this.options[s],
						s: d,
						i: s
					})
				} else r.test(a) && c.push(this.options[s]);
		...
		reset: function(e) {
			...
			for(this.selectedOptions.length = 0, t = 0; t < s.options.length; t++) s.options[t].selected = !1, d.removeClass(this.options[t], "dk-option-selected"), this.options[t].setAttribute("aria-selected", "false"), !e && s.options[t].defaultSelected && this.select(t, !0);
			this.selectedOptions.length || this.multiple || this.select(0, !0)
		},
		refresh: function() {
			a.splice(this.data.cacheID, 1), this.data.elem.parentNode.removeChild(this.data.elem), this.init(this.data.select, this.data.settings)
		},
		...
		_delegate: function(t) {
			...
			if(d.hasClass(n, "dk-option-disabled")) return !1;
			if(this.multiple) {
				if(d.hasClass(n, "dk-option"))
					if(s = e.getSelection(), "Range" == s.type && s.collapseToStart(), t.shiftKey)
						if(a = this.options.indexOf(this.selectedOptions[0]), l = this.options.indexOf(this.selectedOptions[this.selectedOptions.length - 1]), i = this.options.indexOf(n), i > a && l > i && (i = a), i > l && l > a && (l = a), this.reset(!0), l > i)
							for(; l + 1 > i;) this.select(i++);
						else
							for(; i > l - 1;) this.select(i--);
				else t.ctrlKey || t.metaKey ? this.select(n) : (this.reset(!0), this.select(n))
			} else this[this.isOpen ? "close" : "open"](), d.hasClass(n, "dk-option") && this.select(n)
		},
		_highlight: function(e) {
			var t, s = e.target;
			if(!this.multiple) {
				for(t = 0; t < this.options.length; t++) d.removeClass(this.options[t], "dk-option-highlight");
				d.addClass(this.data.elem.lastChild, "dk-select-options-highlight"), d.addClass(s, "dk-option-highlight")
			}
		},
		_keyHandler: function(e) {
			var t, s = this.selectedOptions,
				i = this.options,
				a = 1,
				l = {
					tab: 9,
			...
			switch(e.keyCode) {
				...
				case l.tab:
				case l.enter:
					for(a = 0; a < i.length; a++) d.hasClass(i[a], "dk-option-highlight") && this.select(a);
				case l.esc:
		...
		_searchOptions: function(e) {
			var t, i = this,
				a = String.fromCharCode(e.keyCode || e.which),
				l = function() {
					i.data.searchTimeout && clearTimeout(i.data.searchTimeout), i.data.searchTimeout = setTimeout(function() {
						i.data.searchString = ""
					}, 1e3)
				};
			this.data.searchString === s && (this.data.searchString = ""), l(), this.data.searchString += a, t = this.search(this.data.searchString, this.data.settings.search), t.length && (d.hasClass(t[0], "dk-option-disabled") || this.selectOne(t[0]))
		},
		_scrollTo: function(e) {
			var t, s, i, a = this.data.elem.lastChild;
			return this.isOpen || this.multiple ? ("number" == typeof e && (e = this.item(e)), t = d.position(e, a).top, s = t - a.scrollTop, i = s + e.offsetHeight, void(i > a.offsetHeight ? (t += e.offsetHeight, a.scrollTop = t - a.offsetHeight) : 0 > s && (a.scrollTop = t))) : !1
		}
			...
			n = function(e) {
				...
				switch(e.nodeName) {
					case "OPTION":
						...
						}), d.addClass(s, e.className), e.disabled && (d.addClass(s, "dk-option-disabled"), s.setAttribute("aria-disabled", "true")), e.selected && (d.addClass(s, "dk-option-selected"), s.setAttribute("aria-selected", "true"), l.selected.push(s)), l.options.push(this.appendChild(s));
						break;
					case "OPTGROUP":
						for(i = d.create("li", {
								"class": "dk-optgroup"
							}), e.label && i.appendChild(d.create("div", {
								"class": "dk-optgroup-label",
								innerHTML: e.label
							})), a = d.create("ul", {
								"class": "dk-optgroup-options"
							}), o = e.children.length; o--; r.unshift(e.children[o]));
						r.forEach(n, a), this.appendChild(i).appendChild(a)
				}
			};
		for(l.elem = d.create("div", {
				"class": "dk-select" + (e.multiple ? "-multi" : "")
			}), s = d.create("ul", {
				"class": "dk-select-options",
				id: t + "-listbox",
				role: "listbox"
			}), e.disabled && d.addClass(l.elem, "dk-select-disabled"), l.elem.id = t + (e.id ? "-" + e.id : ""), d.addClass(l.elem, e.className), e.multiple ? (l.elem.setAttribute("tabindex", e.getAttribute("tabindex") || "0"), s.setAttribute("aria-multiselectable", "true")) : (l.elem.appendChild(d.create("div", {
				"class": "dk-selected",
				tabindex: e.tabindex || 0,
				innerHTML: e.options[e.selectedIndex].text,
				id: t + "-combobox",
				"aria-live": "assertive",
				"aria-owns": s.id,
				role: "combobox"
		...
		var s, i, l;
		for((s = t.getElementById(e.target.htmlFor)) && null !== (i = s.getAttribute("data-dkcacheid")) && a[i].data.elem.focus(), l = 0; l < a.length; l++) d.closest(e.target, a[l].data.elem) || a[l].disabled || a[l].close()
	}, e.Dropkick = l
}(window, document);;
...
! function(a) {
	...
	a.DropDown = function(b, c) {
	...
	}, a.DropDown.prototype = {
		_init: function(b) {
			this.options = a.extend(!0, {}, a.DropDown.defaults, b), this._layout(), this._initEvents()
		},
		_layout: function() {
			var b = this;
			this.minZIndex = 1e3, this.dd = this.$el, this.listitems = this.$el, this.opts = this.listitems.children("li"), this.optsCount = this.opts.length, this.opts.each(function() {
				a(this).css("z-index", this.minZIndex + this.optsCount)
			}), this._positionOpts(), Modernizr.csstransitions && setTimeout(function() {
				b.opts.css("transition", "all " + b.options.speed + "ms " + b.options.easing)
			}, 25)
		},
		_positionOpts: function() {
			var b = this;
			this.listitems.css("height", "auto"), this.opts.each(function(c) {
				a(this).css({
					zIndex: b.minZIndex + b.optsCount - 1 - c,
					top: 0,
					right: 0,
					opacity: 0,
					transform: "none"
		...
		_initEvents: function() {
			var a = this;
			this.triggerBtn = this.dd.prev(), this.triggerBtn.on("mousedown", function() {
				return a.opened ? a.close() : a.open(), !1
			})
		},
		open: function() {
			var b = this,
				c = 0;
			this.dd.addClass("active"), this.triggerBtn.addClass("active"), this.opts.each(function(d) {
				var e = a(this).outerHeight();
				c += e, a(this).css(Modernizr.csstransforms ? {
					opacity: 1,
					top: b.options.rotated ? b.options.gutter * d : d * (e + b.options.gutter),
					right: b.options.rotated ? 1 * d : 0,
					marginLeft: 0,
					transform: b.options.rotated ? "right" === b.options.rotated ? "rotate(-" + 2.5 * d + "deg)" : "rotate(" + 2.5 * d + "deg)" : "none"
				} : {
					opacity: 1,
					top: b.options.rotated ? d * (e + 2) : d * (e + b.options.gutter),
					marginLeft: 0
				})
			}), this.listitems.css("height", c = (this.optsCount + 1) * b.options.gutter), this.opened = !0
		},
		close: function() {
			var b = this;
			this.dd.removeClass("active"), this.triggerBtn.removeClass("active"), this.options.delay && Modernizr.csstransitions && this.opts.each(function(c) {
				a(this).css({
					"transition-delay": c * b.options.delay + "ms"
				})
			}), this._positionOpts(), this.opened = !1
		}
	}, a.fn.dropdown = function(b) {
		return "string" != typeof b ? this.each(function() {
			a.data(this, "dropdown") || a.data(this, "dropdown", new a.DropDown(b, this))
		}) : void this.each(function() {
			var c = a.data(this, "dropdown"),
