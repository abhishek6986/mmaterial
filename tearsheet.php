...
<div id="page1">
<table width="595px" height="842px" border="0" align="center">
<tbody>
<tr>
<td align="center" valign="middle" height="842px"><img width="500px" alt="MMATERIAL" src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo-tearsheet.svg"></td>
</tr>
</tbody>
</table>
<pagebreak />
...
if ( ($counting % 2 )== 0 ) {  
        ...
        <table width="595px" height="421px" border="0" align="center">
          <tbody>
          	<tr>
            	<td align="center"><h1 style="text-transform: uppercase; font-size: medium;"><?php the_title(); ?></h1></td>
            </tr>
            <tr>
...
<?php		
        ...
        <table width="595px" height="421px" border="0" align="center">
          <tbody>
          	<tr>
            	<td width="30%" height="50px" valign="middle">Description</td>
            	<td width="70%" height="50px" valign="top"></td>
            </tr>
            <tr>
              <td width="550px"><img width="550" src="<?php the_field('hero_image'); ?>" alt="" /></td>
            </tr>
...
<tbody>
<tr>
<td height="842px" valign="bottom" align="center">
<h2>M Materials</h2>
